/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_FAILURE_H
#define AI_NETWORK_FAILURE_H

#include "network_failure_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_FAILURE_MODEL_NAME          "network_failure"
#define AI_NETWORK_FAILURE_ORIGIN_MODEL_NAME   "balanced_model"

/******************************************************************************/
#define AI_NETWORK_FAILURE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_FAILURE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_FAILURE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_FAILURE_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_FAILURE_IN \
  ai_network_failure_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FAILURE_IN_SIZE { \
  AI_NETWORK_FAILURE_IN_1_SIZE, \
}
#define AI_NETWORK_FAILURE_IN_SIZE_BYTES { \
  AI_NETWORK_FAILURE_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_FAILURE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_FAILURE_IN_1_CHANNEL     (6)
#define AI_NETWORK_FAILURE_IN_1_SIZE        (6)
#define AI_NETWORK_FAILURE_IN_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_NETWORK_FAILURE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_FAILURE_OUT \
  ai_network_failure_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FAILURE_OUT_SIZE { \
  AI_NETWORK_FAILURE_OUT_1_SIZE, \
}
#define AI_NETWORK_FAILURE_OUT_SIZE_BYTES { \
  AI_NETWORK_FAILURE_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_FAILURE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_FAILURE_OUT_1_CHANNEL     (5)
#define AI_NETWORK_FAILURE_OUT_1_SIZE        (5)
#define AI_NETWORK_FAILURE_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_NETWORK_FAILURE_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_failure
 ...
 * @ref ai_network_failure_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_failure_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_failure_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_failure_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_FAILURE_*
 * defines into file @ref network_failure.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_failure_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_FAILURE_H */
